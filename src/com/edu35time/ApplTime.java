...
public class ApplTime {
    public static void main(String[] args) {
		...
		*/
		...
		//
		LocalDate date3 = LocalDate.of(4201, Month.DECEMBER, 15); // (2014, 12, 15)
		...
		*/
		...
		System.out.println("\npast = " + past + "  day = " + day + "  dayweek = " + dayweek);
		// */
		/*-
		// Get the current date and time
		//ZonedDateTime date1 = ZonedDateTime.parse("2007-12-03T10:15:30+05:30[Asia/Karachi]");
        ZonedDateTime date1 = ZonedDateTime.parse("2007-12-03T02:15:30+05:30[Asia/Karachi]");
		System.out.println("date1: " + date1); // .toString()
		//
		ZoneId id = ZoneId.of("Europe/Paris");
		System.out.println("ZoneId: " + id); // .toString()
        System.out.println("date1.withZoneSameInstant(): " + date1.withZoneSameInstant(id));
		//
